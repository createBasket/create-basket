...
const UploadPanel = ({ onTeamsParsed, onClear, onBracketLoaded, disabled }: Props) => {
  ...
  return (
    <div className="panel stack">
      <div>
        <h2>Start from Spreadsheet</h2>
        <div className="status">Upload CSV, XLSX, or bracket JSON. CSV/XLSX should have Team, Priority, Blackout Dates columns.</div>
      </div>
      <input
        type="file"
